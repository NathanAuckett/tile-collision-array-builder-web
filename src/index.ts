    ...
    window.addEventListener("mousedown", (e) => {
        if (e.button == 0){
            ...
            for (let i = 0; i < gridCellCountX; i ++){
                if (heightArray[i] > 0){
                    ctx.fillRect(
                        gridX1 + gridCellWidth * i,
                        gridY2 - gridCellHeight * heightArray[i],
                        gridCellWidth,
                        gridCellHeight * heightArray[i]
                    );
                }
            ...
            for (var i = 0; i < gridCellCountY; i ++){
                if (widthArray[i] > 0){
                    ctx.fillRect(
                        gridX2 - gridCellWidth * widthArray[i],
                        gridY1 + gridCellHeight * i,
                        gridCellWidth * widthArray[i],
                        gridCellHeight
                    );
                }
